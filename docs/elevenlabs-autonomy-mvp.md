...
| 8 | Add optional single-admin Google OAuth | **Select:** event CRUD provides an operator copy while workspace bookings remain the sole availability source; Outlook stays deferred. |
